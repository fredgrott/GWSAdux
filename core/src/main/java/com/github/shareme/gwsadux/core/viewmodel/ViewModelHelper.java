...
import com.github.shareme.gwsadux.core.BuildConfig;
...
public class ViewModelHelper<T extends IView, R extends AbstractViewModel<T>> {
  ...
  public void onCreate(@NonNull Activity activity,
    ...
    final ViewModelProviderImpl.ViewModelWrapper<T> viewModelWrapper = getViewModelProvider(activity).getViewModelProvider().getViewModel(mScreenId, viewModelClass);
  ...
  private ViewModelProvider getViewModelProvider(@NonNull Activity activity) {
    if (!(activity instanceof ViewModelProvider)) {
