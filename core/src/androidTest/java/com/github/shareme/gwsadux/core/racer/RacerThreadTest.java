package com.github.shareme.gwsadux.core.racer;
...
import static com.github.shareme.gwsadux.core.racer.Util.now;
...
public class RacerThreadTest {
    ...
    /**
     * Test fails if {@link MyList#putIfAbsent(Object)} does not have synchronized in its declaration.
     */
    @Test
